...
public class movementTank1 : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if(Input.GetKey("up"))
        {
            rb.transform.Translate(new Vector2(0f, 2f)*Time.deltaTime);
        }
    ...
    void Update()
    {
        ...
        if(gameController.contHereJefe >= 10)
        {
            Destroy(gameObject);
            Instantiate(tank2, new Vector2(0f, 0f), Quaternion.identity);
